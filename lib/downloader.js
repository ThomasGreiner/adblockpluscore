...
Downloader.prototype =
{
  ...
  /**
   * Minimal allowed expiration interval, shorter expiration intervals will be
   * corrected.
   * @type {number}
   */
  minExpirationInterval: 14 * MILLIS_IN_DAY,
   ...
   * @type {number}
   */
  maxExpirationInterval: 28 * MILLIS_IN_DAY,
  ...
  {
    interval = Math.min(
      Math.max(interval, this.minExpirationInterval),
      this.maxExpirationInterval
    );
